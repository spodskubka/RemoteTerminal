...
namespace RemoteTerminal.Terminals
{
    ...
    ///  */
    /// </remarks>
    internal static class CjkWidth
    {
        public const char UCSWIDE = (char)0xdfff;
        ...
        private class IntervalList : List<Interval>
        {
            public void Add(int first, int last)
            {
                Add(new Interval() { first = first, last = last });
            }
        }

        /* sorted list of non-overlapping intervals of non-spacing characters */
        /* generated by "uniset +cat=Me +cat=Mn +cat=Cf -00AD +1160-11FF +200B c" */
        private static IntervalList combining = new IntervalList
        {
        ...
        ///  */
        /// </remarks>
        public static int CharWidth(char ucs)
        {
