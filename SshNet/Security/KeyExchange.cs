...
namespace Renci.SshNet.Security
{
    ...
    public abstract class KeyExchange : Algorithm, IDisposable
    {
        ...
        private Func<byte[], CryptographicKey> _cientHmacAlgorithmType;

        private Func<byte[], CryptographicKey> _serverHmacAlgorithmType;
        ...
        /// </summary>
        /// <returns></returns>
        public CryptographicKey CreateServerHash()
        {
            //  Resolve Session ID
            var sessionId = this.Session.SessionId ?? this.ExchangeHash;
        ...
        /// </summary>
        /// <returns></returns>
        public CryptographicKey CreateClientHash()
        {
            //  Resolve Session ID
            var sessionId = this.Session.SessionId ?? this.ExchangeHash;
        ...
        protected virtual byte[] Hash(byte[] hashData)
        {
            ...
            IBuffer buffer = sha1.HashData(CryptographicBuffer.CreateFromByteArray(hashData));
            byte[] hash;
